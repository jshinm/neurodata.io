...
\pagestyle{fancy}
\pagenumbering{roman}
\chead{\textbf{Joshua Vogelstein, Ph.D.}, Associate Professor, JHU -- Curriculum Vitae}
\rhead{\textbf{\today}}
...
\cventry{02/22 -- }{Associate Professor - Tenured}{Department of Biomedical Engineering}{JHU, Baltimore, MD, USA}{}{}
\cventry{08/14 -- 02/22}{Assistant Professor}{Department of Biomedical Engineering}{JHU, Baltimore, MD, USA}{}{}
...
\begin{refsection}[pubs.bib] 
    ...
    \defbibnote{a1}{{Note: CV author in bold; Trainees are underlined, \\
            \textbf{(85 papers; top 10 cited 5,143 times; H-index 44; 12 first, 18 last, 55 middle authorships)} as of \today}}
    \printbibliography[%
        prenote=a1,% 
        heading=none,%
